            ...
            openapi.Parameter(
                ...
                items=openapi.Items(
                    ...
                    properties={
                        ...
                        "provider": openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Items(type=openapi.TYPE_OBJECT)),
                        "spend_category": openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Items(type=openapi.TYPE_OBJECT)),
                        "emission_breakdown": openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Items(type=openapi.TYPE_OBJECT, properties={
                            "uuid": openapi.Schema(type=openapi.TYPE_STRING),
                            ...
                            "emission_factor": openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Items(type=openapi.TYPE_OBJECT, properties={
                                "uuid": openapi.Schema(type=openapi.TYPE_STRING),
                                "breakdown_name": openapi.Schema(type=openapi.TYPE_STRING),
                                "em_factor": openapi.Schema(type=openapi.TYPE_NUMBER),
                                "source": openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Items(type=openapi.TYPE_OBJECT, properties={
                                    "uuid": openapi.Schema(type=openapi.TYPE_STRING),
                        ...
                        "unit": openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Items(type=openapi.TYPE_OBJECT)),
                        "currency": openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Items(type=openapi.TYPE_OBJECT)),
                        "origin": openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Items(type=openapi.TYPE_OBJECT)),
                    },
                ),
            ),
        ]
